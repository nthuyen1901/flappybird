...
class FlappyBird(object):
    ...
    def is_collided(self):
        ...
        for pipe in self.pipes:
            ...
            # vérifier si la zone de délimitation de l'oiseau chevauche la zone de délimitation d'un tuyau
    ...
    def next_frame(self, action):
        ...
        # mettre à jour l'index et l'itération
        if (self.iter + 1) % 3 == 0:
        ...
        # Mettre à jour la position du tuyau
        for pipe in self.pipes:
